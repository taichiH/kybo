        ...
        for index, row in enumerate(csv_file):
            if len(row.split(',')) == 14:
                ...
                if jockey_winning_count_map.has_key(jockey_name):
                    jockey_winning_count_map[jockey_name] = [0, 0]
                else:
                    ...
                    jockey_data_count += 1
                    jockey_winning_count_map.update({jockey_name: [jockey_data_count, jockey_winning_count]})
                if index != 0:
                    if (horse_past_name != horse_current_name or csv_file_lines - 1 == index):
                        ...
                        horse_winning_percentage_map.update({horse_past_name: horse_winning_percentage})
                        horse_data_count = 0
                        horse_victory_count = 0
                ...
                count = count + 1
        for key, value in jockey_winning_count_map:
